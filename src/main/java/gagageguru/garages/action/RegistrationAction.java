...
public class RegistrationAction extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(path.equalsIgnoreCase("confirmation")){
			...
			//get person id
			List getPersonId = registrationBean.getPersonId(challenge);
			
			registrationBean.confirmation(challenge);
			
			
				
			
			//resp.println("shhshshs"+getPersonId.get(0));
			...
			resp.println(""
					...
					+ "<input type='hidden' class='form-control' id='confirmationKey' name='confirmationKey' value='"+challenge+"'>"
