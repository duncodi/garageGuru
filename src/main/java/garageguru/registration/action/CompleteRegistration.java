package garageguru.registration.action;
...
public class CompleteRegistration extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		confirmationKey = request.getParameter("confirmationKey");
		personId = request.getParameter("ownerId");
		...
		Long personIdLong, garageIdLong;
		personIdLong = Long.parseLong(personId);
		garageIdLong = Long.parseLong(garageId);
		
		registrationBean.addAdmin(user);
		registrationBean.updateGarageAndPerson(confirmationKey, personIdLong, garageIdLong);
