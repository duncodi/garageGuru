...
<body class="dashboard">
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        ...
        <span class="navbar-brand-text hidden-xs"> Garage Guru </span>
      </div>
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar">
          ...
          <li class="dropdown dropdown-fw dropdown-mega">
            ...
            data-animation="fade" role="button">Quick Links <i class="icon wb-chevron-down-mini" aria-hidden="true"></i></a>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">&copy; 2016 <a href="#">Garage Guru</a></div>
